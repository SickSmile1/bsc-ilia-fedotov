...
# %%
mesh, ct, ft, inlet_marker,outlet_marker, upper_wall_marker, lower_wall_marker = create_mesh(MPI.COMM_WORLD, H=1, L=10, lc=0.025)
...
# %%
for j, pressure in enumerate(np.linspace(100, 800, 10)):
    ...
    for i in range(num_steps):
        ...
        if (i % 20 == 0) or (i == num_steps - 1):
            logger.info(
                ...
                f"Time {t:.2f}, Flux center {mass_flow_through_cross_section:.2e}")        
