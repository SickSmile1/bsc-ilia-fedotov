## from https://github.com/IMTEK-Simulation/GroupWiki/blob/master/04_Figures-and-Movies/matplotlib.md
## link to code https://github.com/IMTEK-Simulation/code-snippets/blob/master/imteksimcs/matplotlib/label_lines.py
