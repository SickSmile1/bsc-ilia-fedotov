...
ax.text(1.02, 1., 'Membrane deflation', transform=ax.transAxes, fontsize=14, va='top')
ax.text(1.02, .95, 'min [H]', transform=ax.transAxes, fontsize=14, va='top') 
ax.legend(frameon=False,bbox_to_anchor=(1.0, .9), loc='upper left')
fig = plt.gcf()
