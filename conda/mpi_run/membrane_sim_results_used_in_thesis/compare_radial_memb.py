...
def plot_pres(pt, pt2, file, title,ax, yl='Velocity', legend=True):
    ...
    if legend:        
        ax[0].set_ylabel(r'Velocity U [U]')
...
def plot_press2(pt, pt2, file, title,ax, yl='Velocity',legend=True, filename="output.pdf"):
    ...
    ax[1].set_ylabel(r'Velocity U [U]')
...
neg2, ax[1], radii2, press2, arr2 = plot_press2(pat, pat2, "/p_at_5_0.72/p_at_5.txt", r"Velocity at different $P_g$",ax, yl='P delta', legend=True)
...
# %%
fig, ax = ret_fig_ax(1,2)
neg, ax[0], arr,radii, press  = plot_pres(pat, pat2, "/y_at_5_0.50/y_at_5.txt", "Pressure",ax, yl='P delta', legend=True)
#fig.colorbar(neg, ax=ax[0], location='right', anchor=(0, 0.3), shrink=0.7) # , label="pressure")
ax[0].set_ylim(3.5,10.5)
ax[1].set_ylim(3.5,10.5)
neg2, ax[1], radii2, press2, arr2 = plot_press2(pat, pat2, "/y_at_5_.*_0.72/y_at_5_.*.txt", r"Velocity at different $P_g$",ax, yl='P delta', legend=True)
