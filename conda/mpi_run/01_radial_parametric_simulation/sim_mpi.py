...
def parse_arguments():
    ...
    parser.add_argument("--mode", choices=["single", "loop"], help="Run mode: single run or loop")
...
def run_loop_simulation(comm, radius_range, pressure_range, save, tol):
    ...
    for i, r in enumerate(radius_range):
        # create mesh once with obstacle r for different pressure simulations
...
def show_parameter_info():
    ...
    print("\nExample usage:")
    print("  mpirun -n 4 python3 sim_mpi.py --mode single --save 1 --length 10 --pressure 100 --radius .03")
    ...
    print("\nExample usage:")
    print("  mpirun -n 4 python3 sim_mpi.py --mode loop --save 1 --length 10 --pressure_range 100 500 10 --radius_range 0.1 0.5 10 ")
